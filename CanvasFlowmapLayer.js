(function(factory, window) {
  ...
  var CanvasFlowmapLayer = L.GeoJSON.extend({
    ...
    // kontuz
    // HAU ALDATU DA BALIOA = 1 DUTENAK EZ ERAKUSTEKO (KARGA TXIKITZE ALDERA)
    selectAllFeaturesForPathDisplay: function() {
      this.originAndDestinationGeoJsonPoints.features.forEach(function(feature) {
        if (feature.properties.isOrigin && feature.properties.s_Volume>1 && feature.properties.kanpo==0) {
